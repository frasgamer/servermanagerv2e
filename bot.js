...
client.on('message', message => {
        ...
        .setURL(`https://discordapp.com/api/oauth2/authorize?client_id=526369570122891274&permissions=8&scope=bot`)
...
if(message.content.startsWith(prefix + "daily")) {
  if(profile[message.author.id].lastDaily != moment().format('day')) {
    ...
    profile[message.author.id].credits += 1000
...
const sWlc = {}
const premium = ['476798396250849281', '', '', '']
client.on('message', message => {
var prefix = "+";
...
حآول العبث بالسيرفر ${channel.guild.name}`)
 ...
 channelr[channelremover.id].deleted = 0;
  ...
  client.on('message', message => { 
    ...
    .setFooter(`by TGS_Fras#6671`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
